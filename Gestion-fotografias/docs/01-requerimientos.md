...
| RF13 | El sistema debe permitir al fotógrafo generar un código QR único vinculado a una colección específica (este mismo podrá imprimirse), para permitir el acceso directo, la descarga o la carga colaborativa de contenido durante un evento. |
