...
| HU12 | Como fotógrafo, quiero moderar (aprobar u ocultar) el material que subieron los invitados mediante el QR antes de que sea visible en la colección, para resguardar la calidad del evento.                                                         |       | Media      |
