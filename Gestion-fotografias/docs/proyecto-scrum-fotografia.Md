...
| Exclusiones      | App móvil nativa, integracion con redes sociales, Perfil público con acceso libre a todo el material del fotógrafo, apartado para las Políticas de privacidad y protección de datos, control de espacio de almacenamiento por usuario, restricción de descarga y captura de pantalla en el contenido no adquirido|
...
| ---- | --------------------------------------------------------------------------------------------------------------------------------------- | ------ | --------- |
| HU1  | Como usuario, quiero iniciar sesión en el sistema, para acceder de forma segura a mi panel según mi rol.                                                  |       | Media      |
...
| HU10 | Como cliente autorizado, quiero descargar mis fotos de forma individual o en un archivo comprimido (.zip), para obtener mi material de manera ágil.                     |       | Alta      |
...
| HU12 | Como fotógrafo, quiero moderar (aprobar u ocultar) el material que subieron los invitados mediante el QR antes de que sea visible en la colección, para resguardar la calidad del evento.                                                         |       | Alta      |
| HU13 | Como sistema, quiero realizar un respaldo automático diario de la base de datos y rotar las últimas 3 copias, para mitigar el riesgo de pérdida de datos. |       | Alta      |
| HU14 | Como cliente, quiero visualizar las fotos de mi evento con una marca de agua integrada automáticamente, para poder previsualizar el trabajo antes de descargarlo en máxima resolución.                   |       | Media     |
...
| 15 | HU15 | Ayuda o sección de soporte al usuario | | Sprint 4, si hay capacidad |
