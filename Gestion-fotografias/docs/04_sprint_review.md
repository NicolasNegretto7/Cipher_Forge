...
| **HU18** | Como fotógrafo, quiero editar mi información de perfil profesional y figurar en el directorio general de descubrimiento y eventos públicos. | 3 | **Aceptada** | Pantalla de perfil con nombre y teléfono, visible en el directorio público de fotógrafos (`GET /fotografos`). |
...
### Demostración del Incremento Funcional
1. **Directorio y Perfil Profesional:** Se editó el perfil de Lemuel Swec actualizando nombre y teléfono. Se abrió el directorio general desde el portal de clientes y se comprobó que el perfil figura disponible con sus colecciones públicas asociadas.
