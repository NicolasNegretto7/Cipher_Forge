...
| Claude, Gemini | [Seguridad](04-seguridad.md)  | Validacion: Se validó la documentación mediante uso de AI para mayor rendimiento y velocidad, estas mismas validaciones fueron corroboradas para evitar errores en la misma documentación.  | Augusto Fernández  |
| Claude, Gemini | [Seguridad](04-seguridad.md)  | Mapa de riesgo: El mapa de riesgo pedido en la primera entrega fue hecho en Mermaid para no tener que crear una imagen aparte en el Markdown y así agilizar la documentación.
  | Augusto Fernández  |
...
| Kimi | [Frotend](frontend-fotografo)  | Estilo: El CSS del frontend por ahora será hecho por IA con un diseño genérico para poder preocuparnos por otros aspectos más importantes, como la funcionalidad de la página en sí, en lugar del estilo visual.  | Augusto Fernández  |
